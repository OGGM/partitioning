...
for gdir in gdirs:
    ...
    for g, a in zip(divide.geometry, glaciers.Area):
        ...
        try:
            new_geo.append(_check_geometry(g.buffer(0)))
...
print(sorted_rgi.RGIId)
#sorted_rgi.to_file(os.path.join(base_dir, str(
#    gdir.rgi_region) + '_DividedGlacierInventory.shp'))
